...
const initialOneProduct: IOneProduct = {
  productInfo: {
    ...
    dateOfPrinting: INITIAL_VALUE_STRING,
    printingHouse: INITIAL_VALUE_STRING,
    publishingHouse: INITIAL_VALUE_STRING,
    imageUrl: INITIAL_VALUE_STRING,
    note: INITIAL_VALUE_STRING,
    categoryAlias: INITIAL_VALUE_STRING,
    categoryId: INITIAL_VALUE_NUMBER,
    typeAlias: INITIAL_VALUE_STRING,
    typeId: INITIAL_VALUE_NUMBER,
  },
  pointId: 0,
  serviceInformation: {
    taskId: 0,
